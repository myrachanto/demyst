...
var (
	BlogSectionrepository BlogSectionrepoInterface = &blogSectionrepository{}
	ctx                                            = context.TODO()
	database                                       = "blogsections"
	BlogSectionrepo                                = blogSectionrepository{}
)

type BlogSectionrepoInterface interface {
	Create(section *BlogSection) (*BlogSection, httperrors.HttpErr)
	GetOne(code string) (section *BlogSection, errors httperrors.HttpErr)
	Update(code string, section *BlogSection) (string, httperrors.HttpErr)
	Delete(id string) (string, httperrors.HttpErr)
}

type blogSectionrepository struct{}

func NewblogSectionRepo() BlogSectionrepoInterface {
	return &blogSectionrepository{}
}

func (r *blogSectionrepository) Create(section *BlogSection) (*BlogSection, httperrors.HttpErr) {
...
func (r *blogSectionrepository) GetOne(code string) (section *BlogSection, errors httperrors.HttpErr) {
...
func (r *blogSectionrepository) Update(code string, section *BlogSection) (string, httperrors.HttpErr) {
	stringresults := httperrors.ValidStringNotEmpty(code)
	if stringresults.Noerror() {
...
func (r blogSectionrepository) Delete(id string) (string, httperrors.HttpErr) {
...
func (r blogSectionrepository) genecode() (string, httperrors.HttpErr) {
...
func (r blogSectionrepository) getuno(code string) (result *BlogSection, err httperrors.HttpErr) {
	stringresults := httperrors.ValidStringNotEmpty(code)
	if stringresults.Noerror() {
		return nil, stringresults
	}
...
func (r blogSectionrepository) Count() (float64, httperrors.HttpErr) {
...
func (r blogSectionrepository) EnsureRightData(res *BlogSection) {
	if res.Image != "" {
		res.Content = ""
	} else {
		res.Image = ""
